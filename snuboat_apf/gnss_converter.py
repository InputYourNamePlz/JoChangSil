...
class GNSSConverter(Node):
    def __init__(self):
        ...
        default_params = {
            ...
            # 'Left_Bottom' : [37.455762, 126.9517298, 144.419],
            # 'Right_Bottom' : [37.4558013, 126.95172249999999, 144.53300000000002], # TODO: collect when status = 2
            # 'Left_Top' : [37.45576050, 126.95165367, 144.819],
            # 'Right_Top' : [37.4557979, 126.95164849999999,144.68800000000002],
            # 'origin' : [37.455762, 126.9517298, 144.419],
            'Left_Bottom' : [37.455762, 126.9517298, 144.419],
            'Right_Bottom' : [37.4558013, 126.95172249999999, 144.53300000000002], # TODO: collect when status = 2
            'Left_Top' : [37.45576050, 126.95165367, 144.819],
            'Right_Top' : [37.4557979, 126.95164849999999,144.68800000000002],
            ...
            'origin' : [35.06968750, 128.57890267, 0.0], # Robot land convention center
        }
    ...
    def wait_for_topics(self):
        self.timer = self.create_timer(0.1, self.check_topics_status)
    ...
    def pub_enu_pos(self):
        if self.gps_received:
            ...
            self.pos[0], self.pos[1], self.pos[2] = self.enu_convert([self.gps_lat, self.gps_lon, 0.0])
            enu_pos = Point()
            ...
            print(self.enu_convert([self.origin[0], self.origin[1], 0.0]))
